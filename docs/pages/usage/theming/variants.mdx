...
As of `3.3.0`, Dripsy supports TypeScript intellisense for the `variant` and `variant` props out of the box. For extra customization and more info, see the [Strict Variant](/typescript/variants) docs.
