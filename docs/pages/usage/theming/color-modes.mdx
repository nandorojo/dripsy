...
You should use a library like [`react-native-appearance`](https://docs.expo.dev/versions/latest/sdk/appearance/) to get the system color mode. Or, you can override it with your own.
