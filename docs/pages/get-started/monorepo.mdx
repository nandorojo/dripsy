...
I recommend cloning [this monorepo starter](https://github.com/axeldelafosse/expo-next-monorepo-example) by Axel Delafosse. It comes pre-installed with Dripsy, and it also has a Next.js entrypoint. It's a good starting point for React Native + Next.js.
